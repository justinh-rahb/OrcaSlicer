...
if (MSVC)
    ...
    if (APPLE)
        ...
        # On newer Xcode / macOS, the linker cannot find libSystem unless we
        # pass -isysroot explicitly when -mmacosx-version-min is used.
        set(_sysroot_flag "")
        ...
        if (IS_CROSS_COMPILE)
            ...
            set(_gmp_ccflags "${_gmp_ccflags} ${_gmp_host_arch_flags} ${_sysroot_flag} -mmacosx-version-min=${DEP_OSX_TARGET}")
            set(_gmp_build_tgt --build=${_gmp_build_arch}-apple-darwin --host=${_gmp_host_arch}-apple-darwin)
        else ()
            set(_gmp_ccflags "${_gmp_ccflags} ${_sysroot_flag} -mmacosx-version-min=${DEP_OSX_TARGET}")
